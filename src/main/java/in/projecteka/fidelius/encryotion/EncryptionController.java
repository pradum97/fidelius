...
import in.projecteka.fidelius.ChecksumUtil;
...
public class EncryptionController {
    ...
    public EncryptionResponse encrypt(@RequestBody EncryptionRequest encryptionRequest) throws Exception {
        ...
        String checksum = ChecksumUtil.checksum(encryptedData);

        EncryptionResponse resp = new EncryptionResponse();
        resp.setEncryptedData(encryptedData);
        resp.setChecksum(checksum);
        resp.setKeyToShare(keyToShare);
        return resp;
    }
